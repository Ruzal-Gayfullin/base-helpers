...
{
    public static function getHelper(): MimeTypes
    {
    ...
    public static function getExtensionsListStartedWithDot()
    {
        return Cache::remember(md5(__CLASS__ . __FUNCTION__), 60, fn() => array_map(fn($item) => ".{$item}", array_keys(MimeToExtension::REVERSE_MAP)));
    }
